                  ...
                  <Grid container spacing={2}>
                    ...
                    <Grid item md={6}>
                      <StyledFilterButton
                        ...
                        onClick={() => ( value==='cancelled' ? setFieldValue('status', null) : setFieldValue('status', 'cancelled') )}
                      >
                        Cancelled
                      </StyledFilterButton>
                    </Grid>
                    <Grid item md={6}>
                      <StyledFilterButton
                        ...
                        onClick={() => ( value==='denied' ? setFieldValue('status', null) : setFieldValue('status', 'denied') )}
                      >
                     Denied
                      </StyledFilterButton>
                    </Grid>
