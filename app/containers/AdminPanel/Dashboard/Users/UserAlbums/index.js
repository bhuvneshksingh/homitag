...
import Header from '../../../../../components/AdminPanel/Users/UserAlbums/Header'
import { getUserDetails } from '../api'
import history from '../../../../../utils/history'
import Loading from '../../../../../components/Common/Loading'
import SearchBox from '../../../../../components/AdminPanel/Users/SearchBox'
import Albums from '../../../../../components/AdminPanel/Users/UserAlbums/Albums'
import DownloadCSV from '../../../../../components/AdminPanel/Users/UserAlbums/DownloadCSV'
// pagination
const perPage = 5
    ...
    return (
      <>
        <Container>
          ...
          <Albums userId={savedUser.id} searchText={searchText} perPage={perPage} onPageChange={(page) => setCurrentPage(page)}/>
        </Container>
      </>
    )
  }
