...
export default defineMessages({
  ...
  description: {
    ...
    defaultMessage:
      'We sent a code to {email}. Please enter it below to authenticate your account.',
  },
  mobileFormOpen: {
    id: `${scope}.mobileFormOpen`,
    defaultMessage:
      'Please enter your phone number. We send a verification code to your number.',
  },
  mobileFormDone: {
    id: `${scope}.mobileFormDone`,
    defaultMessage:
      'We send a code to {phonenumber}. Please enter it below to authenticate your account.',
  },
  cantFindCode: {
